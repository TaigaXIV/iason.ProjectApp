Public Class Entry
    ...
    Public Shared Function GetEntries() As IEnumerable(Of Entry)
        ...
        Return New List(Of Entry) From {
            New Entry With {.ProjectId = 1, .Id = 1, .Description = "Just a Test", .StartTime = New DateTimeOffset(Date.Now),
                            .EndTime = New DateTimeOffset(Date.Now), .CostPerHour = 45, .User = New User With {
                            .FirstName = "Kyle", .LastName = "Admin", .Email = "k.admin@online.com", .Password = "adminpassword", .IsAdmin = True}},
            New Entry With {.ProjectId = 4, .Id = 1, .Description = "Just a Test", .StartTime = New DateTimeOffset(Date.Now),
                            .EndTime = New DateTimeOffset(Date.Now), .CostPerHour = 45, .User = New User With {
                            .FirstName = "Kyle", .LastName = "Admin", .Email = "k.admin@online.com", .Password = "adminpassword", .IsAdmin = True}},
            New Entry With {.ProjectId = 3, .Id = 1, .Description = "Just a Test", .StartTime = New DateTimeOffset(Date.Now),
                            .EndTime = New DateTimeOffset(Date.Now), .CostPerHour = 45, .User = New User With {
                            .FirstName = "Kyle", .LastName = "Admin", .Email = "k.admin@online.com", .Password = "adminpassword", .IsAdmin = True}},
            New Entry With {.ProjectId = 1, .Id = 1, .Description = "Just a Test", .StartTime = New DateTimeOffset(Date.Now),
                            .EndTime = New DateTimeOffset(Date.Now), .CostPerHour = 45, .User = New User With {
            ...
            New Entry With {.ProjectId = 1, .Id = 1, .Description = "Just a Test", .StartTime = New DateTimeOffset(Date.Now),
                            .EndTime = New DateTimeOffset(Date.Now), .CostPerHour = 45, .User = New User With {
                            .FirstName = "Kyle", .LastName = "Admin", .Email = "k.admin@online.com", .Password = "adminpassword", .IsAdmin = True}},
            New Entry With {.ProjectId = 2, .Id = 1, .Description = "Just a Test", .StartTime = New DateTimeOffset(Date.Now),
                            .EndTime = New DateTimeOffset(Date.Now), .CostPerHour = 45, .User = New User With {
                            .FirstName = "Kyle", .LastName = "Admin", .Email = "k.admin@online.com", .Password = "adminpassword", .IsAdmin = True}},
            New Entry With {.ProjectId = 1, .Id = 1, .Description = "Just a Test", .StartTime = New DateTimeOffset(Date.Now),
                            .EndTime = New DateTimeOffset(Date.Now), .CostPerHour = 45, .User = New User With {
